package com.rsl.middleware.sdk.infrastructure.git;

import com.rsl.middleware.sdk.types.utils.RandomStringUtils;
...
public class GitCommand {
    ...
    public String commitAndPush(String recommend) throws Exception {
        ...
        logger.info("chatglm-code-review git commit and push done! {}", fileName);
